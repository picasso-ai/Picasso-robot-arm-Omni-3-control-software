...
//websocket case dealing function
void webSocketEvent(uint8_t num, WStype_t type, uint8_t * payload, size_t length) {
    switch(type) {
        ...
        case WStype_CONNECTED: {
            ...
            // Send msg to clinet end webSocket.sendTXT(num, "Hello from ESP32");
        }
            break;
        case WStype_TEXT:
            ...
            if (strncmp((char *)payload, "command", 7) == 0) {
                int commandNum = atoi((char *)(payload + 7)); 
...
//     }
// }
// void buttonCallback_9(Control *sender, int type) 
// {
//     switch (type)
//     {
//     case B_DOWN:
...
void setup()
{
  ...
  if (!WiFi.config(local_IP, gateway, subnet)) {
    ...
    // ESPUI.addControl(ControlType::Number, "delay:", "3000", ControlColor::Sunflower, Control::noParent, &numberCall_1);
    // button1 = ESPUI.addControl(
    //     ControlType::Button, " ", "disable", ControlColor::Peterriver, Control::noParent, &buttonCallback_1);
    // button2 = ESPUI.addControl(
    //     ControlType::Button, " ", "enable", ControlColor::Peterriver, button1, &buttonCallback_2);
    // button3 = ESPUI.addControl(
    //     ControlType::Button, " ", "read current pos", ControlColor::Peterriver, Control::noParent, &buttonCallback_3);
    // button4 = ESPUI.addControl(
    //     ControlType::Button, " ", "save read pos", ControlColor::Peterriver, button3, &buttonCallback_4);
    // button5 = ESPUI.addControl(
    //     ControlType::Button, " ", "clean recorded value", ControlColor::Peterriver, button3, &buttonCallback_5);
    // button6 = ESPUI.addControl(
    //     ControlType::Button, " ", "execute", ControlColor::Peterriver, Control::noParent, &buttonCallback_6);
    // button7 = ESPUI.addControl(
    //     ControlType::Button, " ", "enbale", ControlColor::Peterriver, button6, &buttonCallback_7);
    // button8 = ESPUI.addControl(
    //     ControlType::Button, " ", "open", ControlColor::Peterriver, Control::noParent, &buttonCallback_8);
    // button9 = ESPUI.addControl(
    //     ControlType::Button, " ", "close", ControlColor::Peterriver, button8, &buttonCallback_9);
    ...
    // label1 = ESPUI.label("axis1", ControlColor::Emerald, " ");
    // label2 = ESPUI.label("axis2", ControlColor::Emerald, " ");
    // label3 = ESPUI.label("axis3", ControlColor::Emerald, " ");
    // label4 = ESPUI.label("axis4", ControlColor::Emerald, " ");
    // label5 = ESPUI.label("axis5", ControlColor::Emerald, " ");
    // label6 = ESPUI.label("axis6", ControlColor::Emerald, " ");
    // label7 = ESPUI.label("axis7", ControlColor::Emerald, " ");
